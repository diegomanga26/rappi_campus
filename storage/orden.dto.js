...
export async function orderDto(req,res) {
    ...
    check("adress_to_send").isString().notEmpty().withMessage("adress_to_send is required"),
    check("status").isString().notEmpty().withMessage("status is required"),
    check("detalles_pago").isString().notEmpty().withMessage("detalles_pago is required"),
...
export async function orderDtoUpdate(req,res) {
